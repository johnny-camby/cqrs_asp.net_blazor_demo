...
namespace XmlDataExtractManager.Services
{
    public class XmlDataExtractorService : IXmlDataExtractorService
    {
        ...
        private readonly IDataRepository<ShipInfo> _shipInfoRepository;

        public XmlDataExtractorService(IDataRepository<Customer> customerRepository,
            IDataRepository<FullAddress> fullAddressRepository,
            IDataRepository<Order> orderRepository,
            IDataRepository<ShipInfo> shipInfoRepository)
        {
